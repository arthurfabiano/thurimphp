<div class="container">
    ...
    <hr/>
    <form action="/posts/store" method="POST" accept-charset="utf-8">
        <div class="row">
            <div class="col-lg-9">
                <div class="album py-5 p-4 bg-light">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <input type="text" name="title" class="form-control <?php echo (isset($this->errors['title'])) ? 'is-invalid' : ''; ?>" placeholder="Digite o Título Aqui" value="<?php echo (isset($this->inputs['title'])) ? $this->inputs['title'] : $this->view->post->title; ?>">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <textarea name="content" class="form-control <?php echo (isset($this->errors['content'])) ? 'is-invalid' : ''; ?>" id="conteudo" rows="10" width="100%" placeholder="Digite o Título Aqui"><?php echo (isset($this->inputs['content'])) ? $this->inputs['content'] : $this->view->post->content; ?></textarea>
